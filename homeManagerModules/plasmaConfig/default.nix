...

{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "ksmserver"."Lock Session" = ["Meta+Ctrl+Alt+L,Meta+L" "Screensaver,Lock Session"];
      ...
      "kwin"."Cube" = "Meta+C";
      "kwin"."Cycle Overview" = "Meta+Ctrl+Alt+Shift+G,none,Cycle through Overview and Grid View";
      ...
      "kwin"."KrohnkiteDecrease" = "Meta+O,none,Krohnkite: Decrease";
      ...
      "kwin"."Switch One Desktop Down" = ["Meta+Ctrl+Down" "Meta+Ctrl+Alt+Shift+S,Meta+Ctrl+Down,Switch One Desktop Down"];
      "kwin"."Switch One Desktop Up" = ["Meta+Ctrl+Up" "Meta+Ctrl+Alt+Shift+W,Meta+Ctrl+Up,Switch One Desktop Up"];
      "kwin"."Switch One Desktop to the Left" = "Meta+Ctrl+Left";
      "kwin"."Switch One Desktop to the Right" = "Meta+Ctrl+Right";
      "kwin"."Switch Window Down" = "Meta+Alt+Down";
      "kwin"."Switch Window Left" = ["Meta+Ctrl+Alt+Shift+H" "Meta+Alt+Left,Meta+Alt+Left,Switch to Window to the Left"];
      "kwin"."Switch Window Right" = ["Meta+Alt+Right" "Meta+Ctrl+Alt+Shift+L,Meta+Alt+Right,Switch to Window to the Right"];
      "kwin"."Switch Window Up" = "Meta+Alt+Up";
      "kwin"."Switch to Desktop 1" = ["Meta+Ctrl+Alt+!" "Ctrl+F1,Ctrl+F1,Switch to Desktop 1"];
      ...
      "kwin"."Switch to Desktop 2" = ["Meta+Ctrl+Alt+@" "Ctrl+F2,Ctrl+F2,Switch to Desktop 2"];
      "kwin"."Switch to Desktop 20" = "none,,Switch to Desktop 20";
      "kwin"."Switch to Desktop 3" = ["Ctrl+F3" "Meta+Ctrl+Alt+#,Ctrl+F3,Switch to Desktop 3"];
      "kwin"."Switch to Desktop 4" = ["Meta+Ctrl+Alt+$" "Ctrl+F4,Ctrl+F4,Switch to Desktop 4"];
      "kwin"."Switch to Desktop 5" = "Meta+Ctrl+Alt+%,,Switch to Desktop 5";
      ...
      "kwin"."Switch to Next Screen" = "Meta+.,,Switch to Next Screen";
      "kwin"."Switch to Previous Desktop" = "none,,Switch to Previous Desktop";
      "kwin"."Switch to Previous Screen" = "Meta+\\,,,Switch to Previous Screen";
      ...
      "kwin"."Window Maximize" = ["Meta+Ctrl+Alt+Shift+Return" "Meta+PgUp,Meta+PgUp,Maximize Window"];
      ...
      "kwin"."Window On All Desktops" = "Meta+Ctrl+Alt+Shift+Z,,Keep Window on All Desktops";
      ...
      "kwin"."Window to Desktop 1" = "Meta+Ctrl+Alt+Shift+F1,,Window to Desktop 1";
      ...
      "kwin"."Window to Desktop 2" = "Meta+Ctrl+Alt+Shift+F2,,Window to Desktop 2";
      "kwin"."Window to Desktop 20" = "none,,Window to Desktop 20";
      "kwin"."Window to Desktop 3" = "Meta+Ctrl+Alt+Shift+F3,,Window to Desktop 3";
      "kwin"."Window to Desktop 4" = "Meta+Ctrl+Alt+Shift+F4,,Window to Desktop 4";
      "kwin"."Window to Desktop 5" = "Meta+Ctrl+Alt+Shift+F5,,Window to Desktop 5";
      ...
      "kwin"."Window to Next Screen" = ["Meta+Shift+Right" "Meta+Ctrl+Alt+Shift+O" "Meta+>,Meta+Shift+Right,Move Window to Next Screen"];
      "kwin"."Window to Previous Desktop" = "none,,Window to Previous Desktop";
      "kwin"."Window to Previous Screen" = ["Meta+<" "Meta+Shift+Left,Meta+Shift+Left,Move Window to Previous Screen"];
    ...
    configFile = {
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."b24a5f68-136a-4d01-9a23-af8328369f71" = "650da140-d0dc-4878-95f5-d1539b7c971d";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-H-Splitter" = "0,827,0";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-2-Splitter" = 1107;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 561;
      ...
      "kate/anonymous.katesession"."MainWindow0-Splitter 0"."Sizes" = 827;
